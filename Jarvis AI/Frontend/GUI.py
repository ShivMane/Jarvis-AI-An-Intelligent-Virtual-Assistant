...
class ChatSection(QWidget): 
        ...
        def loadMessages(self):
            ...
            response_file = TempDirectoryPath('Response.data')
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        max_gix_size_H = int(screen_width / 16 * 9)
        movie.setScaledSize(QSize(screen_width, max_gix_size_H))
    ...
    def toggle_icon(self, event=None):
        print("✅ Mic button clicked!")  # ✅ Debugging print

        if self.toggled:
            self.load_icon(GraphicsDirectoryPath('Mic_on.png'), 60, 60)
            MicButtonInitialed()
            print("✅ Mic is ON")  # ✅ Debugging print

        else:
            self.load_icon(GraphicsDirectoryPath('Mic_off.png'), 60, 60)
            MicButtonClosed()
            print("✅ Mic is OFF")  # ✅ Debugging print
